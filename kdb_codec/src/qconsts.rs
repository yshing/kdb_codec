//! Q type indicators and attribute constants.
...
pub mod qtype {
    ...
    /// Type indicator of q composition.
    pub const COMPOSITION: c_schar = 105;
    ...
    /// Type indicator of q dynamic load (aka foreign function object).
