...
fn main() {
    ...
    let mut timestamp_list = K::new_timestamp_list(
        vec![NaiveDate::from_ymd_opt(2021, 3, 9)
            .unwrap()
            .and_hms_nano_opt(12, 5, 40, 67824)
            .unwrap()
    ...
    timestamp_list
        .push(
            &NaiveDate::from_ymd_opt(2021, 3, 13)
                .unwrap()
                .and_hms_nano_opt(5, 47, 2, 260484387)
                .unwrap()
                .and_local_timezone(Utc)
                .unwrap(),
        )
    ...
    timestamp_list
        .insert(
            0,
            &NaiveDate::from_ymd_opt(2020, 4, 19)
                .unwrap()
                .and_hms_nano_opt(5, 40, 45, 850935582)
                .unwrap()
                .and_local_timezone(Utc)
                .unwrap(),
        )
